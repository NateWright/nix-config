{ ... }:
{
  services.borgbackup.repos = {
    ...
    nwright-framwork = {
      authorizedKeys = [
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIP9VcMhXvStjGxvfhAkDJzffFuXc11kWDmQnp6gB2DbH nwright@nwright-framework"
      ];
      path = "/vault/backups/backup_nwright_nwright-framework";
    };
  };
}
