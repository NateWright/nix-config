      ...
      settings = [
        {
          ...
          "hyprland/workspaces" = {
            ...
            persistent-workspaces = {
              ...
              "1" = if (hostname == "phasma" || hostname == "vader") then [ "DP-1" ] else [ "eDP-1" ];
              "2" = if (hostname == "phasma" || hostname == "vader") then [ "DP-1" ] else [ "eDP-1" ];
              "3" =
                if (hostname == "phasma") then
                  [ "DP-1" ]
              ...
              "6" =
                if (hostname == "phasma") then
                  ...
                  [ "eDP-1" ];
              "7" = if (hostname == "phasma" || hostname == "vader") then [ "DP-1" ] else [ "eDP-1" ];
              "8" = if (hostname == "phasma" || hostname == "vader") then [ "DP-1" ] else [ "eDP-1" ];
              "9" =
                if (hostname == "phasma") then
                  [ "HDMI-A-1" ]
                else if (hostname == "vader") then
